...
public final class HttpUrlUtils {
  ...
  public static void addParamIfValid(
  ...
  public static void addDateRangeParamsIfValid(
      final HttpUrl.Builder httpUriBuilder,
  ...
  private static boolean isValidDateRange(final String dateFromValue, final String dateToValue) {
    try {
