...
public class TimeUtils {
  ...
  public static final DateTimeFormatter SIMPLE_DATE_FORMAT =
  ...
  public static String toDateStringMinusDays(
      final ZonedDateTime zonedDateTime, final int minusDays) {
